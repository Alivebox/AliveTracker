/**
 * @class AliveTracker.view.projects.calendar.CalendarPanel
 * @extends Ext.Panel
 ...
 * {@link #calendarStore} config containing records of type {@link AliveTracker.view.projects.calendar.EventRecord EventRecord}. In order
 ...
 * @xtype calendarpanel
 */
Ext.define('AliveTracker.view.projects.calendar.CalendarPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.calendarpanel',

    requires: [
        'Ext.layout.container.Card',
        'AliveTracker.view.projects.calendar.view.Day',
        'AliveTracker.view.projects.calendar.view.Week',
        'AliveTracker.view.projects.calendar.view.Month',
        'AliveTracker.view.projects.calendar.form.EventDetails'
    ],
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The new {@link AliveTracker.view.projects.calendar.EventRecord record} that was added
             */
            eventadd: true,
            /**
             * @event eventupdate
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The new {@link AliveTracker.view.projects.calendar.EventRecord record} that was updated
             */
            eventupdate: true,
            /**
             * @event eventdelete
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The new {@link AliveTracker.view.projects.calendar.EventRecord record} that was removed
             */
            eventdelete: true,
            /**
             * @event eventcancel
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The new {@link AliveTracker.view.projects.calendar.EventRecord record} that was canceled
             */
            eventcancel: true,
            /**
             * @event viewchange
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {Ext.AliveTracker.view.projects.calendar.view.AbstractCalendar} view The view being activated (any valid {@link AliveTracker.view.projects.calendar.view.AbstractCalendar AbstractCalendar} subclass)
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The {@link AliveTracker.view.projects.calendar.EventRecord record} for the event that was clicked on
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The {@link AliveTracker.view.projects.calendar.EventRecord record} for the event that the cursor is over
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The {@link AliveTracker.view.projects.calendar.EventRecord record} for the event that the cursor exited
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The {@link AliveTracker.view.projects.calendar.EventRecord record} for the event that was moved with
             ...
             * @param {AliveTracker.view.projects.calendar.CalendarPanel} this
             * @param {AliveTracker.view.projects.calendar.EventRecord} rec The {@link AliveTracker.view.projects.calendar.EventRecord record} for the event that was resized
    ...
    onEventAdd: function(form, rec) {
        rec.data[AliveTracker.view.projects.calendar.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * @param {AliveTracker.view.projects.calendar.EventRecord} record The event record to edit
     * @return {AliveTracker.view.projects.calendar.CalendarPanel} this
     */
     ...
     * {@link AliveTracker.view.projects.calendar.view.AbstractCalendar AbstractCalendar}.
     * @return {AliveTracker.view.projects.calendar.view.AbstractCalendar} The active view
     */
