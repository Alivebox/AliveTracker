 ...
 */
Ext.define('AliveTracker.view.projects.calendar.data.EventModel', {
    extend: 'Ext.data.Model',
    
    requires: [
        'AliveTracker.view.projects.calendar.util.MixedCollection',
    ...
    statics: {
        ...
        reconfigure: function() {
            var Data = AliveTracker.view.projects.calendar.data,
...
function(){
    AliveTracker.view.projects.calendar.data.EventModel.reconfigure();
});