 ...
 */
Ext.define('AliveTracker.view.projects.calendar.data.MemoryCalendarStore', {
    extend: 'Ext.data.Store',
    model: 'AliveTracker.view.projects.calendar.data.CalendarModel',
    
    requires: [
        'Ext.data.proxy.Memory',
        'Ext.data.reader.Json',
        'Ext.data.writer.Json',
        'AliveTracker.view.projects.calendar.data.CalendarModel',
        'AliveTracker.view.projects.calendar.data.CalendarMappings'
    ],
    ...
    initComponent: function() {
        var me = this,
            calendarData = AliveTracker.view.projects.calendar.data;
