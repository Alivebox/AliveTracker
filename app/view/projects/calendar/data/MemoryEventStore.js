 ...
 */
Ext.define('AliveTracker.view.projects.calendar.data.MemoryEventStore', {
    extend: 'Ext.data.Store',
    model: 'AliveTracker.view.projects.calendar.data.EventModel',
    ...
    constructor: function(config){
        ...
        this.sorters = this.sorters || [{
            property: AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name,
            direction: 'ASC'
        }];
        
        this.idProperty = this.idProperty || AliveTracker.view.projects.calendar.data.EventMappings.EventId.mapping || 'id';
        this.fields = AliveTracker.view.projects.calendar.data.EventModel.prototype.fields.getRange();
    ...
    interceptCreateRecords: function(records, operation, success) {
        if (success) {
            ...
            for (; i < len; i++) {
                records[i].data[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name] = records[i].id;
            }
        }
    },
