 ...
 */
Ext.define('AliveTracker.view.projects.calendar.dd.DayDropZone', {
    extend: 'AliveTracker.view.projects.calendar.dd.DropZone',
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = AliveTracker.view.projects.calendar.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = AliveTracker.view.projects.calendar.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || AliveTracker.view.projects.calendar.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = AliveTracker.view.projects.calendar.util.Date.copyTime(n.date, this.resizeDt);
                start = AliveTracker.view.projects.calendar.util.Date.min(data.eventStart, curr);
                end = AliveTracker.view.projects.calendar.util.Date.max(data.eventStart, curr);
