 ...
 */
Ext.define('AliveTracker.view.projects.calendar.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'AliveTracker.view.projects.calendar.dd.StatusProxy',
    ...
    constructor: function(el, config) {
        if (!AliveTracker.view.projects.calendar._statusProxyInstance) {
            AliveTracker.view.projects.calendar._statusProxyInstance = new AliveTracker.view.projects.calendar.dd.StatusProxy();
        }
        this.proxy = AliveTracker.view.projects.calendar._statusProxyInstance;
    ...
    getDragData: function(e) {
        ...
        if (t) {
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name],
                eventEnd: rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name],
                proxy: this.proxy
            };
        }
