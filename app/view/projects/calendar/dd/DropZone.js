 ...
 */
Ext.define('AliveTracker.view.projects.calendar.dd.DropZone', {
    ...
    shim: function(start, end) {
        ...
        var dt = Ext.Date.clone(start),
            ...
            shim,
            box,
            D = AliveTracker.view.projects.calendar.util.Date,
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = AliveTracker.view.projects.calendar.util.Date.copyTime(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name], n.date);
