 ...
 */
Ext.define('AliveTracker.view.projects.calendar.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.eventeditform',
    
    requires: [
        'AliveTracker.view.projects.calendar.form.field.DateRange',
        'AliveTracker.view.projects.calendar.form.field.ReminderCombo',
        'AliveTracker.view.projects.calendar.data.EventMappings',
        'AliveTracker.view.projects.calendar.form.field.CalendarCombo'
    ],
    ...
    initComponent: function() {
        ...
        this.titleField = new Ext.form.Text({
            fieldLabel: 'Title',
            name: AliveTracker.view.projects.calendar.data.EventMappings.Title.name,
            emptyText: 'Event Title',
            allowBlank: false,
            anchor: '90%'
        });
        this.dateRangeField = new AliveTracker.view.projects.calendar.form.field.DateRange({
            fieldLabel: 'When',
            singleLine: false,
            anchor: '90%'
        });
        this.reminderField = new AliveTracker.view.projects.calendar.form.field.ReminderCombo({
            name: 'Reminder',
            anchor: '70%'
        });
        this.notesField = new Ext.form.TextArea({
            fieldLabel: 'Notes',
            name: AliveTracker.view.projects.calendar.data.EventMappings.Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.Text({
            fieldLabel: 'Location',
            name: AliveTracker.view.projects.calendar.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel: 'Web Link',
            name: AliveTracker.view.projects.calendar.data.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new AliveTracker.view.projects.calendar.form.field.CalendarCombo({
                store: this.calendarStore,
                anchor: '70%',
                name: AliveTracker.view.projects.calendar.data.EventMappings.CalendarId.name
            });
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({
                'calendar': rec.data[AliveTracker.view.projects.calendar.data.EventMappings.CalendarId.name]
            });
        }
