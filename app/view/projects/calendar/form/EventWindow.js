 ...
 */
Ext.define('AliveTracker.view.projects.calendar.form.EventWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.eventeditwindow',
    
    requires: [
        'Ext.form.Panel',
        'AliveTracker.view.projects.calendar.data.EventModel',
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || AliveTracker.view.projects.calendar.util.Date.add(start, {hours: 1});

            rec = Ext.create('AliveTracker.view.projects.calendar.data.EventModel');
            rec.data[M.StartDate.name] = start;
            rec.data[M.EndDate.name] = end;
            rec.data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != AliveTracker.view.projects.calendar.util.Date.add(end, {millis: 1}).getDate();
