 ...
 */
Ext.define('AliveTracker.view.projects.calendar.form.field.CalendarCombo', {
    ...
    initComponent: function(){
        this.valueField = AliveTracker.view.projects.calendar.data.CalendarMappings.CalendarId.name;
        this.displayField = AliveTracker.view.projects.calendar.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item ext-color-{' + AliveTracker.view.projects.calendar.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function(value){
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[AliveTracker.view.projects.calendar.data.CalendarMappings.CalendarId.name] : val);
        }
        return '';
    },
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[AliveTracker.view.projects.calendar.data.CalendarMappings.CalendarId.name];
        }
