 ...
 */
Ext.define('AliveTracker.view.projects.calendar.form.field.DateRange', {
...
//        };
    ...
    setValue: function(v){
        ...
        else if(v[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name], 'end');
            }
        }
    },
