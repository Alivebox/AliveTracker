 ...
 */
Ext.define('AliveTracker.view.projects.calendar.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = AliveTracker.view.projects.calendar.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = AliveTracker.view.projects.calendar.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            ...
            dt = AliveTracker.view.projects.calendar.util.Date.add(dt, {hours: 1});
        }
