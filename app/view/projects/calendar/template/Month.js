 ...
 */
Ext.define('AliveTracker.view.projects.calendar.template.Month', {
    extend: 'Ext.XTemplate',
    
    requires: ['AliveTracker.view.projects.calendar.template.BoxLayout'],
    
    constructor: function(config){
        
        Ext.apply(this, config);
    
        this.weekTpl = new AliveTracker.view.projects.calendar.template.BoxLayout(config);
