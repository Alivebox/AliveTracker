 ...
 */
Ext.define('AliveTracker.view.projects.calendar.view.AbstractCalendar', {
    ...
    getWeekCount: function() {
        var days = AliveTracker.view.projects.calendar.util.Date.diffDays(this.viewStart, this.viewEnd);
            ...
            for (d = 0; d < this.dayCount; d++) {
                if (evtsInView.getCount() > 0) {
                    var evts = evtsInView.filterBy(function(rec) {
                        var startDt = Ext.Date.clearTime(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name], true),
                            startsOnDate = dt.getTime() == startDt.getTime(),
                            spansFromPrevView = (w == 0 && d == 0 && (dt > rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name]));
                ...
                dt = AliveTracker.view.projects.calendar.util.Date.add(dt, {days: 1});
            }
        }
    ...
    prepareEventGrid: function(evts, w, d) {
        ...
        evts.each(function(evt) {
            var M = AliveTracker.view.projects.calendar.data.EventMappings,
            days = AliveTracker.view.projects.calendar.util.Date.diffDays(
                AliveTracker.view.projects.calendar.util.Date.max(this.viewStart, evt.data[M.StartDate.name]),
                AliveTracker.view.projects.calendar.util.Date.min(this.viewEnd, evt.data[M.EndDate.name])) + 1;

            if (days > 1 || AliveTracker.view.projects.calendar.util.Date.diffDays(evt.data[M.StartDate.name], evt.data[M.EndDate.name]) > 1) {
    ...
    onEventDrop: function(rec, dt) {
        if (AliveTracker.view.projects.calendar.util.Date.compare(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name], dt) === 0) {
            // no changes
            return;
        }
        var diff = dt.getTime() - rec.data[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name].getTime();
        rec.set(AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name, dt);
        rec.set(AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name, AliveTracker.view.projects.calendar.util.Date.add(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name], {millis: diff}));
    ...
    onCalendarEndDrag: function(start, end, onComplete) {
        if (start && end) {
            ...
            var o = {};
            o[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name] = start;
            o[AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name] = end;
    ...
    onUpdate: function(ds, rec, operation) {
        ...
        if (operation == Ext.data.Record.COMMIT) {
            ...
            if (this.enableFx && this.enableUpdateFx) {
                this.doUpdateFx(this.getEventEls(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name]), {
                    scope: this
                });
            }
        }
    ...
    onAdd: function(ds, records, index) {
        ...
        if (this.enableFx && this.enableAddFx) {
            this.doAddFx(this.getEventEls(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name]), {
                scope: this
            });
        };
    },
    ...
    onRemove: function(ds, rec) {
        ...
        if (this.enableFx && this.enableRemoveFx) {
            this.doRemoveFx(this.getEventEls(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name]), {
                remove: true,
                scope: this,
            ...
            this.getEventEls(rec.data[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name]).remove();
            this.refresh();
        }
    },
    ...
    isEventVisible: function(evt) {
        ...
        M = AliveTracker.view.projects.calendar.data.EventMappings,
        data = evt.data || evt,
        evStart = data[M.StartDate.name].getTime(),
        evEnd = AliveTracker.view.projects.calendar.util.Date.add(data[M.EndDate.name], {seconds: -1}).getTime(),
    ...
    isOverlapping: function(evt1, evt2) {
        ...
        end1 = AliveTracker.view.projects.calendar.util.Date.add(ev1[M.EndDate.name], {seconds: -1}).getTime(),
        start2 = ev2[M.StartDate.name].getTime(),
        end2 = AliveTracker.view.projects.calendar.util.Date.add(ev2[M.EndDate.name], {seconds: -1}).getTime();
...
//        });
    ...
    setViewBounds: function(startDate) {
        var start = startDate || this.startDate,
            ...
            Dt = AliveTracker.view.projects.calendar.util.Date;
    ...
    sortEventRecordsForDay: function(evts) {
        ...
        evts.sortBy(Ext.bind(function(evtA, evtB) {
            ...
            if (this.spansHavePriority) {
                ...
                var diff = AliveTracker.view.projects.calendar.util.Date.diffDays;
    ...
    moveNext: function(noRefresh) {
        return this.moveTo(AliveTracker.view.projects.calendar.util.Date.add(this.viewEnd, {days: 1}));
    },
    ...
    movePrev: function(noRefresh) {
        var days = AliveTracker.view.projects.calendar.util.Date.diffDays(this.viewStart, this.viewEnd) + 1;
    ...
    moveMonths: function(value, noRefresh) {
        return this.moveTo(AliveTracker.view.projects.calendar.util.Date.add(this.startDate, {months: value}), noRefresh);
    },
    ...
    moveWeeks: function(value, noRefresh) {
        return this.moveTo(AliveTracker.view.projects.calendar.util.Date.add(this.startDate, {days: value * 7}), noRefresh);
    },
    ...
    moveDays: function(value, noRefresh) {
        return this.moveTo(AliveTracker.view.projects.calendar.util.Date.add(this.startDate, {days: value}), noRefresh);
    },
    ...
    getEventRecord: function(id) {
        var idx = this.store.find(AliveTracker.view.projects.calendar.data.EventMappings.EventId.name, id);
