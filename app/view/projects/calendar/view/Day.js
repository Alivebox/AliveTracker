 ...
 */
Ext.define('AliveTracker.view.projects.calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.dayview',
    
    requires: [
        'AliveTracker.view.projects.calendar.view.AbstractCalendar',
        'AliveTracker.view.projects.calendar.view.DayHeader',
        'AliveTracker.view.projects.calendar.view.DayBody'
    ],
