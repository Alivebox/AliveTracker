 ...
 */
Ext.define('AliveTracker.view.projects.calendar.view.DayBody', {
    extend: 'AliveTracker.view.projects.calendar.view.AbstractCalendar',
    alias: 'widget.daybodyview',

    requires: [
        'Ext.XTemplate',
        'AliveTracker.view.projects.calendar.template.DayBody',
        'AliveTracker.view.projects.calendar.data.EventMappings',
        'AliveTracker.view.projects.calendar.dd.DayDragZone',
        'AliveTracker.view.projects.calendar.dd.DayDropZone'
    ],
    ...
    initDD: function() {
        ...
        this.dragZone = new AliveTracker.view.projects.calendar.dd.DayDragZone(this.el, Ext.apply({
            view: this,
            containerScroll: true
        },
        cfg));

        this.dropZone = new AliveTracker.view.projects.calendar.dd.DayDropZone(this.el, Ext.apply({
            view: this
        },
        cfg));
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AliveTracker.view.projects.calendar.template.DayBody({
                id: this.id,
    ...
    onEventResize: function(rec, data) {
        var D = AliveTracker.view.projects.calendar.util.Date,
        start = AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name,
        end = AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name;
    ...
    getTemplateEventData: function(evt) {
        var selector = this.getEventSelectorCls(evt[AliveTracker.view.projects.calendar.data.EventMappings.EventId.name]),
            data = {},
    ...
    getTemplateEventBox: function(evt) {
        var heightFactor = 0.7,
            start = evt[AliveTracker.view.projects.calendar.data.EventMappings.StartDate.name],
            end = evt[AliveTracker.view.projects.calendar.data.EventMappings.EndDate.name],
        ...
        for (; day < this.dayCount; day++) {
            ...
            for (; ev < ct; ev++) {
                ...
                evts.push({
                    ...
                    date: AliveTracker.view.projects.calendar.util.Date.add(this.viewStart, {days: day})
                });
            }
        }
    ...
    getDayAt: function(x, y) {
        var xoffset = this.el.down('.ext-cal-day-times').getWidth(),
            ...
            mins = rowIndex * 30,
            dt = AliveTracker.view.projects.calendar.util.Date.add(this.viewStart, {days: dayIndex, minutes: mins}),
            el = this.getDayEl(dt),
            timeX = x;
    ...
    onClick: function(e, t) {
        if (this.dragPending || AliveTracker.view.projects.calendar.view.DayBody.superclass.onClick.apply(this, arguments)) {
