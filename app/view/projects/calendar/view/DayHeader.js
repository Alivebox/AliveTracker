 ...
 */
Ext.define('AliveTracker.view.projects.calendar.view.DayHeader', {
    extend: 'AliveTracker.view.projects.calendar.view.Month',
    alias: 'widget.dayheaderview',

    requires: [
        'AliveTracker.view.projects.calendar.template.DayHeader'
    ],
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AliveTracker.view.projects.calendar.template.DayHeader({
                id: this.id,
