 ...
 */
Ext.define('AliveTracker.view.projects.calendar.view.Month', {
    extend: 'AliveTracker.view.projects.calendar.view.AbstractCalendar',
    alias: 'widget.monthview',
    
    requires: [
        'Ext.XTemplate',
        'AliveTracker.view.projects.calendar.template.Month',
        'AliveTracker.view.projects.calendar.util.WeekEventRenderer',
        'AliveTracker.view.projects.calendar.view.MonthDayDetail'
    ],
    ...
    initDD: function() {
        ...
        this.dragZone = new AliveTracker.view.projects.calendar.dd.DragZone(this.el, cfg);
        this.dropZone = new AliveTracker.view.projects.calendar.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AliveTracker.view.projects.calendar.template.Month({
                id: this.id,
    ...
    renderItems: function() {
        AliveTracker.view.projects.calendar.util.WeekEventRenderer.render({
    ...
    getDayAt: function(x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = AliveTracker.view.projects.calendar.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function(e, t) {
        ...
        if (AliveTracker.view.projects.calendar.view.Month.superclass.onClick.apply(this, arguments)) {
